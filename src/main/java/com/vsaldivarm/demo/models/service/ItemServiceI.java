...
@Service
public class ItemServiceI implements ItemService {
    ...
    public Item findById(Long id, Integer amoung) {
        ...
        Product product = clientRest.getForObject("http://localhost:8001/ver/{id}", Product.class
        ,pathVariables);
        return new Item(product,amoung);
    }
}
